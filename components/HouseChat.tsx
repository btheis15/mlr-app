    ...
    <>
      ...
      <div className="shrink-0 border-t border-border bg-card" style={embedded ? undefined : { paddingBottom: "env(safe-area-inset-bottom)" }}>
        ...
        {/* ── Attach + poll ─────────────────────────────────────────────────
            ...
            delivered the file: you could pick a photo and hit the checkmark and
            nothing arrived in the composer, with no error. Two rounds of
            ...
            Video / Choose File", so camera + documents are still one tap away,
            via the native path the Main Feed already relies on. ── */}
