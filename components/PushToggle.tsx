...
const TYPES: { value: PushType; label: string; desc: string; adminOnly?: boolean }[] = [
  ...
  { value: "new_post", label: "New posts in the Feed", desc: "When anyone shares a new post — off by default" },
  ...
  { value: "help_request", label: "Help requests near me", desc: "When someone at the resort asks for help (needs \"Willing to help\" on too) — on by default" },
