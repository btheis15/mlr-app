...
async function start() {
  ...
  // Push is realtime-only (no DB-claim/sweep backstop like the mailer), so a
  // silently-dropped channel means push delivery stops until the mini restarts.
  // Resubscribe on CHANNEL_ERROR/TIMED_OUT/CLOSED — same pattern as alert-mailer.js.
